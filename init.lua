...
require("lazy").setup({
...

  {
    ...
    opts = {
      ...
      enabled = function()
        ...
        disabled = disabled or (vim.tbl_contains({ "text" }, vim.bo.filetype))
        return not disabled
      end,
...

  {
    ...
    config = function()
      ...
      vim.lsp.enable({ "lua_ls", "tailwindcss", "ruff", "emmet_language_server", "zls", "angularls", "pylsp", "ts_ls",
        "gopls" })
...
autocmd("BufWinEnter", {
  ...
  callback = function()
    ...
    vim.keymap.set("n", "<leader>fp", "<cmd>!wip<CR>", opts)
...
require("supermaven-nvim").setup({
  ...
  ignore_filetypes = { "cpp", "c", "go", "zig", "md", "git", "COMMIT_EDITMSG", "cs" },
  color = {
